...
int main(void) {
    ...
    while(1)     //循环
    {
        ...
        //---------显示X轴
        Angle_XY= atan2((double)qmcY,(double)qmcX) * (180 / 3.14159265) + 180; //计算XY平面角度
        Angle_XY*=10;

        Angle_XZ= atan2((double)qmcZ,(double)qmcX) * (180 / 3.14159265) + 180; //计算XZ平面角度
        Angle_XZ*=10;

        Angle_YZ= atan2((double)qmcZ,(double)qmcY) * (180 / 3.14159265) + 180; //计算YZ平面角度
        Angle_YZ*=10;
        system_delay_ms(100);
    }
}
